...
type ClientRequest struct {
	...
	PersonName        string    `json:"person_name" binding:"omitempty,min=2,max=200"`
	DateOfBirth       time.Time `json:"date_of_birth" binding:"omitempty"`
	Cpf               string    `json:"cpf" binding:"omitempty,min=14,max=14"`
	Gender            string    `json:"gender" binding:"omitempty,min=2,max=50"`
	TelephoneNumber   string    `json:"telephone_number" binding:"omitempty,min=14,max=14"`
	CellphoneNumber   string    `json:"cellphone_number" binding:"omitempty,min=16,max=16"`
	Email             string    `json:"email" binding:"omitempty,email,max=1000"`
}
